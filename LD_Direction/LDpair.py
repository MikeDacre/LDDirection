...
def calculate_pair(snp1, snp2, pops, outfile=None):
    ...
    # Create JSON output
    snp1_chrom = snp1_chrom if snp1_chrom.startswith('chr') else 'chr' + snp1_chrom
    snp2_chrom = snp2_chrom if snp2_chrom.startswith('chr') else 'chr' + snp2_chrom
